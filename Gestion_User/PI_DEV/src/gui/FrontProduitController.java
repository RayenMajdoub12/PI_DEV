...
public class FrontProduitController implements Initializable {
   ...
   private List<produit> produits = new ArrayList<>();
    ...
    private List<produit> getData() {
        ...
        Produit.setPrix(3);
        Produit.setImgSrc("/images/2.png");
        ...
        Produit.setPrix(2);
        Produit.setImgSrc("/images/8.png");
        ...
        Produit.setPrix(5);
        Produit.setImgSrc("/images/4.png");
        ...
        Produit.setNom_p("HALTERE");
        Produit.setPrix(2);
        Produit.setImgSrc("/images/3.png");
        ...
        Produit.setPrix(2);
        Produit.setImgSrc("/images/5.png");
        ...
        Produit.setPrix(3);
        Produit.setImgSrc("/images/7.png");
        Produit.setColor("DC143C");
        produits.add(Produit);
        ...
        Produit.setPrix(2);
        Produit.setImgSrc("/images/10.png");
        Produit.setColor("8A2BE2");
        produits.add(Produit);
        ...
        Produit.setPrix(5);
        Produit.setImgSrc("/images/11.png");
        Produit.setColor("6495ED");
        produits.add(Produit);
        ...
        Produit.setPrix(23);
        Produit.setImgSrc("/images/6.png");
        Produit.setColor("00BFFF");
        produits.add(Produit);
        ...
        Produit.setPrix(2);
        Produit.setImgSrc("/images/9.png");
        Produit.setColor("F08080");
        produits.add(Produit);
    ...
    private void setChosenProduit(produit produit) {
        ...
        produitPriceLabel.setText( produit.getPrix()+NewFXMain.CURRENCY );
       ...
       produits.addAll(getData());
        if (produits.size() > 0) {
            ...
            myListener2 = new MyListener2() {
                @Override
                public void onClickListener2(produit produit) {
        ...
        try {
            for (int i = 0; i < produits.size(); i++) {
                ...
                itemController.setData(produits.get(i),myListener2);
