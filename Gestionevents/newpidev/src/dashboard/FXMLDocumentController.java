...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML
    private JFXButton btnNom;
    @FXML
    private JFXButton btnPrix;
    @FXML
    private JFXButton btnLieu;
    @FXML
    private JFXButton btnDatedebut;
    @FXML
    private JFXButton btnDatefin;
    @FXML
    private ListView<?> listofvew;
    @FXML
