...
public class EvenementService implements IService<Evenements>{
   ...
   //TODATE BECH NSALHOUHAAAAAAAA  W9AYET EKHER
        ...
        try {
            Mail.sendMail("mohamedgasmi1998@gmail.com");
        } catch (Exception ex) {
            Logger.getLogger(EvenementService.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void delete(int id) {
        ...
        System.out.println("cette event est supprimer avec success");
    }
   ...
   public void edit (int id , int stat)
   {
    ...
    public void update(Evenements e, int id) throws Exception {
